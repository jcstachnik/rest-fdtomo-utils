...
Vpxpar=${wdir}/Output/Vpxsection.par
cat <<EOF > $Vpxpar
# fdloc event file
evtfile=${wdir}/Output/$findat
...
psf=0.2
# 
hitdir=${wdir}/Output/Vp-hits
# 
topogrd=/data/TOPO/Projects/mongolia_large.grd
# 
stafile=${wdir}/Output/station.list
#  X or Y section
xy="X"
...
Vpypar=${wdir}/Output/Vpysection.par
cat <<EOF > $Vpypar
# fdloc event file
evtfile=${wdir}/Output/$findat
wid=15 # event projection width
...
# --------------------------------------------
# make the parfile for creating Vpysections
Vpzpar=${wdir}/Output/Vpzsection.par
cat <<EOF > $Vpzpar
# fdloc event file
evtfile=${wdir}/Output/$findat
wid=15 # event projection width
