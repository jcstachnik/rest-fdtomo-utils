...
Vsxpar=${wdir}/$outdir/Vsxsection.par
cat <<EOF > $Vsxpar
# fdloc event file
...
Vsypar=${wdir}/$outdir/Vsysection.par
cat <<EOF > $Vsypar
# fdloc event file
evtfile=${wdir}/$outdir/$findat
wid=15 # event projection width
...
${plotbin}/plot_many_x_2.sh $xmn $xmx $Vsxpar
...
${plotbin}/plot_many_y_2.sh $ymn $ymx $Vsypar
